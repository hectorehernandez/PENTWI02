                ...
                $.getJSON("http://www.thecocktaildb.com/api/json/v1/1/filter.php?c=" + value,
                    function(data) {
                        ...
                        data.drinks.forEach(function(element) {
                            var drinkElement = "<div class=\"card\" style=\"width: 16rem;\"><img class=\"card-img-top\" src=\"" + element.strDrinkThumb + "\" /><div class=\"card-body\"><h6 class=\"card-title\">" + element.strDrink + "</h6></div></div>";
